...
/**
 * Ein Rennpferd, das durch ein Startsignal losläuft. Nach einer zufälligen Zeit kommt es im Ziel an.
 */
public final class RaceHorse implements Runnable {
    ...
    public void run() {
        ...
        try {
            ...
            LOG.debug(ex);
            LOG.info("Rennpferd " + runThread.getName() + " geht zurück in die Box.");
        }
