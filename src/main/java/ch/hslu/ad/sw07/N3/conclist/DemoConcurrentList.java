 ...
 */
package ch.hslu.ad.sw07.N3.conclist;
...
public final class DemoConcurrentList {
    ...
    private static final Logger LOG = LogManager.getLogger(ch.hslu.ad.sw07.N3.conclist.DemoConcurrentList.class);
    ...
    public static void main(final String args[]) throws InterruptedException, ExecutionException {
       ...
       // BlockingQueue<Integer>list1 = new LinkedBlockingQueue<Integer>();
