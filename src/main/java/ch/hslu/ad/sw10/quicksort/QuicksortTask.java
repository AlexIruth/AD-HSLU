...
public final class QuicksortTask extends RecursiveAction {
    ...
    private static final int THRESHOLD = 10_000_000/ Runtime.getRuntime().availableProcessors();
    ...
    protected void compute() {
        ...
        if (max - min < THRESHOLD) {
            ...
            QuicksortTask quicksortTask1 = new QuicksortTask(array, min, partition - 1);
            QuicksortTask quicksortTask2 = new QuicksortTask(array, partition + 1, max);
