...
public final class MergesortTask extends RecursiveAction {
    ...
    private static final int THRESHOLD = 375_000;
    ...
    protected void compute() {
        if (max - min < THRESHOLD) {
            ...
            MergesortTask mergesortTask1 = new MergesortTask(array, min, mid);
            MergesortTask mergesortTask2 = new MergesortTask(array, mid, max);
