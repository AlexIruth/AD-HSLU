...
public final class RandomInitTask extends RecursiveAction {
    ...
    public static void main(String[] args) throws InterruptedException, ExecutionException {
        ...
        int[] array = {2, 4, 32, 4, 341, 23, 2, 312, 312, 565};
        RandomInitTask randomInitTask = new RandomInitTask(array, 2);
        forkJoinPool.submit(randomInitTask);
        System.out.println(randomInitTask.get());
